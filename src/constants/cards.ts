...
export const MARKET_PERKS: CardDef<MarketCard>[] = [
  ...
  { name: 'Journal', description: 'After playing an Event card, discard this to repeat the effect.', cost: 1, source: 'PUBLIC', type: 'PERK', copies: 2 },
...
export const MARKET_WEAPONS: CardDef<MarketCard>[] = [
  { name: 'Bat', description: '+2 power.', cost: 3, source: 'PUBLIC', type: 'WEAPON', weaponType: 'MELEE', power: 2, copies: 1 },
  { name: 'Pocket Knife', description: '+1 power for each perk and weapon you have (including this).', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'MELEE', power: 0, copies: 1 },
  { name: 'Switch Blade', description: '+2 power, +2 more if your opponent has a Chemical weapon.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'MELEE', power: 2, copies: 1 },
  { name: 'Hammer', description: '+2 power. Before combat, draw a card.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'MELEE', power: 2, copies: 1 },
  { name: 'Axe', description: '+5 power.', cost: 5, source: 'PUBLIC', type: 'WEAPON', weaponType: 'MELEE', power: 5, copies: 1 },
  { name: 'Arrows', description: '+2 power.', cost: 3, source: 'PUBLIC', type: 'WEAPON', weaponType: 'RANGED', power: 2, copies: 1 },
  { name: 'Pistol', description: '+4 power. Before combat, discard a card (if possible).', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'RANGED', power: 4, copies: 1 },
  { name: 'Harpoon', description: '+2 power, +2 more if your opponent has a Melee weapon.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'RANGED', power: 2, copies: 1 },
  { name: 'Catapult', description: 'You may attack non-neighbors OR +1 power.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'RANGED', power: 2, copies: 1 },
  { name: 'Machine Gun', description: '+3 power. Power phase: discard Money cards for +1 power each. May attack non-neighbors.', cost: 5, source: 'PUBLIC', type: 'WEAPON', weaponType: 'RANGED', power: 3, copies: 1 },
  { name: 'Electric Baton', description: '+2 power.', cost: 3, source: 'PUBLIC', type: 'WEAPON', weaponType: 'TECH', power: 2, copies: 1 },
  { name: 'Missile', description: '+2 power. If you win with this, destroy one of the opponent’s perks.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'TECH', power: 2, copies: 1 },
  { name: 'Magnetic Deflector', description: '+2 power, +2 more if your opponent has a Ranged weapon.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'TECH', power: 2, copies: 1 },
  { name: 'Signal Jammer', description: '+2 power. Your opponent may not play Power cards.', cost: 5, source: 'PUBLIC', type: 'WEAPON', weaponType: 'TECH', power: 2, copies: 1 },
  { name: 'Robot Soldier', description: '+1 power for every card you hold, max +5.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'TECH', power: 0, copies: 1 },
  { name: 'Toxic Gas', description: '+2 power.', cost: 3, source: 'PUBLIC', type: 'WEAPON', weaponType: 'CHEMICAL', power: 2, copies: 1 },
  { name: 'Viruses', description: '+2 power. After combat, give your opponent a Virus token (-1 action).', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'CHEMICAL', power: 2, copies: 1 },
  { name: 'Corrosion Cannisters', description: '+2 power, +2 more if your opponent has a Tech weapon.', cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'CHEMICAL', power: 2, copies: 1 },
  { name: 'Parasites', description: "Power equal to your opponent's role base PL.", cost: 4, source: 'PUBLIC', type: 'WEAPON', weaponType: 'CHEMICAL', power: 0, copies: 1 },
  { name: 'Mosquitos', description: '+3 power. Before combat, randomly make your opponent discard a card.', cost: 5, source: 'PUBLIC', type: 'WEAPON', weaponType: 'CHEMICAL', power: 3, copies: 1 },
];
